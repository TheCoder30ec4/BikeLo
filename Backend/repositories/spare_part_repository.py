...
class SparePartRepository:
    ...
    def add_images(self, part_id: int, urls: List[str], *, commit: bool = True) -> Optional[SparePart]:
    ...
    def clear_images(self, part_id: int, *, commit: bool = True) -> bool:
        part = self.get_by_id(part_id)
        if not part:
            return False
    ...
    def update(self, part_id: int, data: dict, *, commit: bool = True) -> Optional[SparePart]:
        part = self.get_by_id(part_id)
        if not part:
            return None
